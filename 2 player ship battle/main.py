...
pygame.display.set_caption("First game!") # tech with Tim tutorial
...
BULLET_VEL = 7
MAX_BULLETS = 3
BORDER = pygame.Rect(WIDTH//2 - 5, 0, 10, HEIGHT) #x, y, width, height (2 slashes to round to integer)
...
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'fire_sound.mp3'))
...
def draw_winner(text):
    ...
    pygame.time.delay(3000) #show winnder and wait 5 seconds before restarting game
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    for bullet in red_bullets:
        pygame.draw.rect(WIN, RED, bullet) #draw to window, color, the rectangle object
...
def main():
    #representes red and yellow ship position
    red = pygame.Rect(700, 200, SPACESHIP_WIDTH, SPACESHIP_HEIGHT) #x, y, width, height
    ...
    winner = ""
    while run:
        #make sure the screen refreshes only 60 times per second
        clock.tick(FPS) 
